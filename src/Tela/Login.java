...
public class Login extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/icons8-senha-48.png"))); // NOI18N
        jLabel3.setText("Senha:");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/icons8-gmail-novo-48.png"))); // NOI18N
        ...
        btnEntrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/icons8-usuário-50 (1).png"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/icons8-k-67.png"))); // NOI18N
        ...
        jLabel5.setText("Gerenciador de Empresas by Samuel Kern");
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        ...
        if (TxtEmail.getText().trim().length() > 0 && String.valueOf(txtSenha.getPassword()).trim().length() > 0) {

            Funcionarios o = new Funcionarios();
            o.setEmail(TxtEmail.getText());
            o.setSenha(String.valueOf(txtSenha.getPassword()));

            if (new FuncionariosDAO().autenticar(o)) {
